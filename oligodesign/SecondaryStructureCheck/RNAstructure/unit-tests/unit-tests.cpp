...
void test_Misc() {
	...
	str->AddStructure();
	str->SetEnergy(2,36);
	TEST_EQUAL(s=NO_CT_ENERGY_COMMENTS.getComment(str, 1), "");
	TEST_EQUAL(s=NO_CT_ENERGY_COMMENTS.getComment(str, 2), "");
	TEST_EQUAL(s=DEFAULT_CT_ENERGY_COMMENTS.getComment(str, 1), "");
	TEST_EQUAL(s=DEFAULT_CT_ENERGY_COMMENTS.getComment(str, 2), "ENERGY = 3.6");
	delete str;
}
